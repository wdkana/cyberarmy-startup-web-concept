...
<body class="navbar-top">
    ...
    <!-- Main navbar -->
    <?php $this->load->view('dashboard/admin/header');?>
    <!-- /main navbar -->
    <!-- Page container -->
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <!-- Page header -->
                <?php if($this->uri->segment(2)=='program_da'){?>
                ...
                <?php }else {?>
                    <div class="page-header page-header-default">
                        ...
                        <div class="breadcrumb-line">
                            <ul class="breadcrumb">
                                <li>
                                    <a href="<?php echo site_url('mejadankursi');?>">
                                        <i class="icon-home2 position-left"></i> Home</a>
                                </li>
                                <?php if($this->uri->segment(2)=='detail_ktp' || $this->uri->segment(2)=='detail_sim' || $this->uri->segment(2)=='detail_passport'){?>
                                    <li>
                                    <a href="<?php echo site_url('mejadankursi/data_user');?>">
                                        <i class="icon-user position-left"></i> Data User</a>
                                    </li>
                                <?php } ?>

...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
                ...
                if (len > 0) { //jika ada isinya
                    if (!valid_username(username)) { //jika username tidak valid
                        ...
                        if (len > 30) { //jika karakter >30
                            ...
                            var valid = false;
                            $.ajax({
                                url: "<?php echo site_url('user/cekusername_ct');?>",
                                type: "POST",
            ...
            $('#no_tlp').blur(function () {
                ...
                if (len > 0) { //jika ada isinya
                    if (!valid_no_tlp(no_tlp)) { //jika username tidak valid
                        $(this).parent().find('.text-warning').text("");
                        $(this).parent().find('.text-warning').text("No Telepon Tidak Valid");
                        return apply_feedback_error(this);
                    } else {
                        if (len > 12) {
                            $(this).parent().find('.text-warning').text("");
                            $(this).parent().find('.text-warning').text("Maximal Karakter 12");
                            return apply_feedback_error(this);
                        }
                    }
                }
                ...
                if (len > 0) {
                    if (!valid_email(email)) {
                        ...
                        if (len > 30) {
                            ...
                            var valid = false;
                            $.ajax({
                                url: "<?php echo site_url('user/cekmail_ct');?>",
                                type: "POST",
                                data: "email=" + email,
                                dataType: "text",
                                success: function (data) {
            ...
            $('#password').blur(function () {
                ...
                if (len > 0 && len < 12) {
                    $(this).parent().find('.text-warning').text("");
                    $(this).parent().find('.text-warning').text("password minimal 8 - 12 karakter");
                    return apply_feedback_error(this);
                } else {
                    if (len > 35) {
                        $(this).parent().find('.text-warning').text("");
            ...
            $('#formInput').submit(function (e) {
                ...
                if (valid) {
                    swal({
                        ...
                        $.ajax({
                            url: "<?php echo site_url('user/prosess_sign_up_ct');?>",
                            type: "POST",
    ...
    <style>
        .page-container {
            background-image: url('<?php echo base_url();?>assets/img/bg15.jpg');
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                        ...
                        <div class="panel panel-body login-form">
                            <div class="text-center">
                                <div class="icon-object border-indigo text-indigo">
                                    <i class="icon-office text-indigo"></i>
                                </div>
                            ...
                            <div class="content-divider text-muted form-group">
                                <span>Beritahu kami tentang Perusahaan Anda</span>
                            </div>
                            <div class="form-group form-group-lg has-feedback">
                                <label for="perusahaan">Nama Perusahaan</label>
                                <input type="text" name="perusahaan" id="perusahaan" class="form-control textbox">
                                <i class="form-control-feedback"></i>
                                <span class="text-warning"></span>
                            </div>
                            <div class="form-group form-group-lg has-feedback">
                                <label for="no_tlp">No Tlp Perusahaan</label>
                                <input type="text" name="no_tlp" id="no_tlp" placeholder="Optional" class="form-control textbox">
                                <i class="form-control-feedback"></i>
                                <span class="text-warning"></span>
                            </div>
                            <div class="content-divider text-muted form-group">
                                <span>Rincian Perusahaan Anda</span>
                            </div>
                            <div class="form-group form-group-lg has-feedback">
                            ...
                            <a href="<?php echo site_url('user/sign_in_costumer');?>" class="btn bg-indigo-300 btn-block content-group">Sign In</a>
                            <span class="help-block text-center no-margin">By continuing, you're confirming that you've read our
                    ...
                    <ol class="breadcrumb">
							...
							<li>
								<a href="<?php echo site_url('user/sign_in_costumer');?>">Login Costumer</a>
							</li>
							<li class="active">Daftar Costumer</li>
						</ol>
                    </div>
                    <!-- /footer -->

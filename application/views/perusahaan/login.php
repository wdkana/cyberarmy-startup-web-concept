	...
	<div class="page-container" style=" ">
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
					<!-- Advanced login -->
				<?php echo form_open('user/prosess_sign_in_ct');?>
						...
						<?php } ?>
							<div class="text-center">
								<div class="icon-object border-indigo text-indigo"><i class="icon-office text-indigo"></i></div>
								<h5 class="content-group">Login to your account <small class="display-block">Your Costumer (Company)</small></h5>
							</div>
							...
							<a href="<?php echo site_url('user/sign_up_costumer');?>" class="btn bg-indigo-300 btn-block content-group">Sign up</a>
					...
					<div class="footer text-muted text-center">
						<ol class="breadcrumb">
							...
							<li class="active">Login Costumer</li>
						</ol>
					</div>
					<!-- /footer -->
